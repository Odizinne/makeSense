...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.shortcutComboBox.setMinimumSize(QtCore.QSize(0, 25))
        ...
        self.keepDualsenseHiddenBox = QtWidgets.QCheckBox(parent=self.gridFrame)
        self.keepDualsenseHiddenBox.setMinimumSize(QtCore.QSize(0, 25))
        self.keepDualsenseHiddenBox.setToolTip("")
        self.keepDualsenseHiddenBox.setLayoutDirection(QtCore.Qt.LayoutDirection.RightToLeft)
        self.keepDualsenseHiddenBox.setText("")
        self.keepDualsenseHiddenBox.setObjectName("keepDualsenseHiddenBox")
        self.gridLayout_2.addWidget(self.keepDualsenseHiddenBox, 1, 1, 1, 1)
        ...
        self.keepDualsenseHiddenLabel = QtWidgets.QLabel(parent=self.gridFrame)
        self.keepDualsenseHiddenLabel.setMinimumSize(QtCore.QSize(0, 25))
        self.keepDualsenseHiddenLabel.setObjectName("keepDualsenseHiddenLabel")
        self.gridLayout_2.addWidget(self.keepDualsenseHiddenLabel, 1, 0, 1, 1)
        ...
        self.batteryLabel_3.setMinimumSize(QtCore.QSize(0, 25))
        font = QtGui.QFont()
        font.setBold(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.keepDualsenseHiddenLabel.setToolTip(_translate("MainWindow", "By default, dualsense is hidden only when using virtual XBOX controller.\n"
"Enabling this will prevent any application to see your dualsense controller,\n"
"even if virtual XBOX controller is disabled or makeSense is closed.\n"
"Do not check unless you have specific needs or you might get stuck with no controller detected."))
        self.keepDualsenseHiddenLabel.setText(_translate("MainWindow", "Keep Dualsense hidden ⚠️"))
